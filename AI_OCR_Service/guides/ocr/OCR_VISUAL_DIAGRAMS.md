...
```
    ...
    Success    Failure          │
      ...
      │         │                    │
      │         ▼                    ▼
      │    Try Google Vision    Try PaddleOCR-VL
      │         │                    │
      │    ┌────┴────┐               │
      │  Success  Failure            │
      │    │         │               │
      │    │         └─────┬─────────┘
      │    │               │
      │    │      Are PaddleOCR-VL dependencies installed?
      │    │               │
      │    │         ┌─────┴────────┐
      │    │        Yes            No
      │    │         │              │
      │    │         ▼              ▼
      │    │    Try PaddleOCR-VL      HTTP 502 Error
      │    │         │              │
      │    │    ┌────┴────┐         │
      │    │  Success  Failure      │
      │    │    │         │         │
...
PaddleOCR-VL Final Fallback (2% of requests):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 10-20s
 ▓▓ 2%
...
```
                GEMINI      GOOGLE VISION   PaddleOCR-VL
┌──────────────┬──────────┬──────────────┬──────────┐
│ Speed        │ ⚡⚡⚡   │ 🟡🟡       │ 🐢      │
...
NEW SYSTEM (Gemini Primary):
  ...
  │ ├─ 20% need fallback, use PaddleOCR-VL (10-20s) ✅
...
└──────┬───────┘
       ...
       ▼
┌──────────┐
│  PaddleOCR-VL   │ ← Offline, Last resort
└──────────┘
...
└──────────┬───────────────┘
           ...
           └──────────┬───────────────┘
                      ...
                      └─ Success → ✅ Tier 2 ready
                                  ...
                                  ▼
           ┌──────────────────────────┐
           │ Test Tier 3: PaddleOCR-VL
           │ Try extract_text_with_PaddleOCR-VL()
           └──────────┬───────────────┘
                      │
                      ├─ Failed → ⚠️ Warn: PaddleOCR-VL unavailable
                      │           (Deps not installed)
                      │
